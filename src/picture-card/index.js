  ...
  function render(picture) {
    ...
    return yo`<div class="card ${picture.liked ? 'liked' : ''}">
      <div class="card-image">
        ...
        <i class="fa fa-heartbeat like-heartbeat ${ picture.likedHeart ? 'liked' : '' }"></i>
      </div>
      <div class="card-content">
        ...
        <a class="left" href="#" onclick=${like.bind(null, false)}><i class="fa fa-heartbeat heartbeat" aria-hidden="true"></i></a>
