        ...
        ${user.pictures.map(function (picture) {
          return yo`<div class="col s12 m6 l4">
            <a href="/${user.username}/${picture.id}" class="picture-container">
              ...
              <div class="likes"><i class="fa fa-heartbeat"></i> ${picture.likes}</div>
            </a>
            <div id="modal${picture.id}" class="modal modal-fixed-footer">
              ...
              <div class="modal-footer">
                <div class="btn btn-flat likes"><i class="fa fa-heartbeat"></i> ${translate('likes', { likes: picture.likes })}</div>
              </div>
            </div>
          </div>`;
        })}
